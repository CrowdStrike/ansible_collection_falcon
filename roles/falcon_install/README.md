 ...
 * `falcon_sensor_version` - Sensor version to install (mutually exclusive w/ `falcon_sensor_version_decrement`) (string, default: null)
 * `falcon_sensor_version_decrement` - Sensor N-x version to install (mutually exclusive w/ `falcon_sensor_version`) (int, default: 0 [latest])
